<x-filament-panels::page class="h-full">
    <div class="flex h-[calc(100vh-8rem)] gap-6" x-data="{ cartOpen: false }">
        <!-- Sidebar: Categories -->
    ...
    <!-- Cart Drawer -->
    <div x-show="cartOpen || {{ count($cart) > 0 ? 'true' : 'false' }}"
        ...
        <div class="p-6 border-b border-gray-100 bg-white z-10 flex justify-between items-center">
            ...
            <button @click="cartOpen = false" class="md:hidden text-gray-400 hover:text-gray-600">
